        ...
        <form className="mx-auto max-w-xl" onSubmit={handleSubmit}>
          ...
          <div className="items-center justify-stretch w-full grid place-items-center">
            <label
             ...
             border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500
               dark:hover:bg-gray-600 mt-5 ${
                 !uploadImage ? "visible" : "hidden"
               }`}
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <Upload />
                <p className="mb-2 text-sm text-gray-500 dark:text-gray-400 md:text-center">
